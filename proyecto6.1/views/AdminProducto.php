...
<head>
    ...
    <link rel="icon" href="../assets/camilo/pictures/logo sin fondo.png" type="image/x-icon">

    <style>
        body {
            background-image: url(../assets/Andres/img/fondo.jpg);
            }
    </style>
</head>
<body>
    <div class="container mt-5">
    <h1 class="text-center my-4 text-white border border-dark p-3 " style="border-radius: 30px; background-color:rgba(112,208,223,255) ">Productos en catálogo</h1>
